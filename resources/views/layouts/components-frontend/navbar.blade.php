            ...
            <div class="row common__row position-relative">
                <div class="col-xl-2 col-lg-2 col-md-6">
                    <div class="headerarea__logo">
                        <a href="#"><img src="{{asset('img/logo/logo__1.png')}}" alt=""></a>
                    </div>
                </div>
                                    ...
                                    <ul class="headerarea__submenu headerarea__megamenu">
                                            ...
                                            <ul>
                                                <li>
                                                    <a href="categories.html">
                                                        <img class="img-fluid" src="{{asset('img/collection/collection__1.png')}}"
                                                            alt="Collection">
                                                    </a>
                                                </li>
                                            </ul>
                                        ...
                                        <li class="mega__menu__li mega__menu__image">
                                            ...
                                            <ul>
                                                <li>
                                                    <a href="categories.html">
                                                        <img class="img-fluid" src="{{asset('img/collection/collection__2.png')}}"
                                                            alt="Collection">
                                                    </a>
                                                </li>
                                            </ul>
                                        ...
                                        <li class="mega__menu__li mega__menu__image">
                                            ...
                                            <ul>
                                                <li>
                                                    <a href="categories.html">
                                                        <img class="img-fluid" src="{{asset('img/collection/collection__3.png')}}"
                                                            alt="Collection">
                                                    </a>
                                                </li>
                                            </ul>
                                        ...
                                        <li class="mega__menu__li mega__menu__image">
                                            ...
                                            <ul>
                                                <li>
                                                    <a href="categories.html">
                                                        <img class="img-fluid" src="{{asset('img/collection/collection__4.png')}}"
                                                            alt="Collection">
                                                    </a>
                                                </li>
                                            </ul>
                                        ...
                                        <li class="mega__menu__li mega__menu__image">
                                            ...
                                            <ul>
                                                <li>
                                                    <a href="categories.html">
                                                        <img class="img-fluid" src="{{asset('img/collection/collection__5.png')}}"
                                                            alt="Collection">
                                                    </a>
                                                </li>
                                            </ul>
                                        ...
                                        <li class="mega__menu__li mega__menu__image">
                                            ...
                                            <ul>
                                                <li>
                                                    <a href="categories.html">
                                                        <img class="img-fluid" src="{{asset('img/collection/collection__6.png')}}"
                                                            alt="Collection">
                                                    </a>
                                                </li>
                                            </ul>
                                        ...
                                        <li class="mega__menu__li mega__menu__image">
                                            ...
                                            <ul>
                                                <li>
                                                    <a href="categories.html">
                                                        <img class="img-fluid" src="{{asset('img/collection/collection__7.png')}}"
                                                            alt="Collection">
                                                    </a>
                                                </li>
                                            </ul>
                                        ...
                                        <li class="mega__menu__li mega__menu__image">
                                            ...
                                            <ul>
                                                <li>
                                                    <a href="categories.html">
                                                        <img class="img-fluid" src="{{asset('img/collection/collection__8.png')}}"
                                                            alt="Collection">
                                                    </a>
                                                </li>
                                            </ul>
        ...
        <div class="row align-items-center">
            ...
            <div class="col-sm-4 col-5">
                <div class="mobile-logo">
                    <a class="logo__mobile" href="#"><img src="{{asset('img/logo/logo__1.png')}}" alt="logo"></a>
                </div>
            </div>
            <div class="col-sm-4 col-5">
    ...
    <div class="mobile-off-canvas-active">
        ...
        <div class="header-mobile-aside-wrap">
            ...
            <div class="mobile__logo">
                <a href="index.html">
                    <img src="{{asset('img/logo/logo__1.png')}}" alt="Logo">
                </a>
            </div>
            ...
            <div class="minicart__wrapper">
                ...
                <div class="minicart__single__wraper">
                    <div class="minicart__single">
                        ...
                        <div class="minicart__single__img">
                            <a href="single-product.html">
                                <img src="{{asset('img/grid/grid__1.png')}}" alt="product">
                            </a>
                    ...
                    <div class="minicart__single">
                        ...
                        <div class="minicart__single__img">
                            <a href="single-product.html">
                                <img src="{{asset('img/grid/grid__2.png')}}" alt="product">
                            </a>
                            <div class="minicart__single__close">
                                <button title="Remove"><i class="fa fa-close"></i></button>
                            </div>
