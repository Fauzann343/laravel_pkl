...
@section('content')
       ...
       <div class="testimonial sp_bottom_80">
        <div class="container testimonial_color testimonialcolor_5">
            <div class="row testimonial_slideractive sliderdefaultarrow sliderdefaultdot sliderdefault_dot--2">
                <div class="col-xl-12">
                    <div class="testimonial_inner testimonial_padding text-center">
    ...
    <!-- testimonial_section_start -->
        ...
        <!-- brant_section_start -->
            <div class="brand sp_bottom_80">
                <div class="container">
                    <div class="brand_wraper brandslider_active">
