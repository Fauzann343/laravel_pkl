                ...
                <div class="container herobannerarea__slider  slider__default__arrow slider__default__dot">
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 col-12 herobanner__img__side">
                                <div class="herobanner__img">
                                    <img src="{{asset('assets/img/herobanner/main_herobanner__2.png')}}" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="herobannerarea__slider__single">
                        <div class="row align-items-center">
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 col-12 herobanner__img__side">
                                <div class="herobanner__img">
                                    <img src="{{asset('img/herobanner/main_herobanner__1.png')}}" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="herobannerarea__slider__single">
                        <div class="row align-items-center">
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 col-12 herobanner__img__side">
                                <div class="herobanner__img">
                                    <img src="{{asset('img/herobanner/main_herobanner__3.png')}}" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="row">
            <div class="col-xl-6 col-lg-6 col-md-6 col-12">
                <div class="banner__img">
                    <img src="{{asset('img/banner/banner__1.png')}}" alt="">
            ...
            <div class="col-xl-6 col-lg-6 col-md-6 col-12">
                <div class="banner__img">
                    <img src="{{asset('img/banner/banner__2.png')}}" alt="">
                    <div class="banner__info">
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-4 col-sm-6 col-6">
                        <div class="grid__wraper">
                            <div class="grid__wraper__img">
                                <div class="grid__wraper__img__inner">
                                    <a href="single-product.html">
                                        <img class="primary__image" src="{{asset('img/grid/grid__3.png')}}" alt="Primary Image">
                                        <img class="secondary__image" src="{{asset('img/grid/grid__4.png')}}" alt="Secondary Image">
                                    </a>
                                </div>
                                <div class="grid__wraper__icon">                                
                                    <ul>
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-4 col-sm-6 col-6">
                        <div class="grid__wraper">
                            <div class="grid__wraper__img">
                                <div class="grid__wraper__img__inner">
                                    <a href="single-product.html">
                                        <img class="primary__image" src="{{asset('img/grid/grid__5.png')}}" alt="Primary Image">
                                        <img class="secondary__image" src="{{asset('img/grid/grid__6.png')}}" alt="Secondary Image">
                                    </a>
                                </div>
                                <div class="grid__wraper__icon">                                
                                    <ul>
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-4 col-sm-6 col-6">
                        <div class="grid__wraper">
                            <div class="grid__wraper__img">
                                <div class="grid__wraper__img__inner">
                                    <a href="single-product.html">
                                        <img class="primary__image" src="{{asset('img/grid/grid__15.png')}}" alt="Primary Image">
                                        <img class="secondary__image" src="{{asset('img/grid/grid__16.png')}}" alt="Secondary Image">
                                    </a>
                                </div>
                                <div class="grid__wraper__icon">                                
                                    <ul>
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-4 col-sm-6 col-6">
                        <div class="grid__wraper">
                            <div class="grid__wraper__img">
                                <div class="grid__wraper__img__inner">
                                    <a href="single-product.html">
                                        <img class="primary__image" src="{{asset('img/grid/grid__17.png')}}" alt="Primary Image">
                                        <img class="secondary__image" src="{{asset('img/grid/grid__18.png')}}" alt="Secondary Image">
                                    </a>
                                </div>
                                <div class="grid__wraper__icon">                                
                                    <ul>
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-4 col-sm-6 col-6">
                        <div class="grid__wraper">
                            <div class="grid__wraper__img">
                                <div class="grid__wraper__img__inner">
                                    <a href="single-product.html">
                                        <img class="primary__image" src="{{asset('img/grid/grid__21.png')}}" alt="Primary Image">
                                        <img class="secondary__image" src="{{asset('img/grid/grid__22.png')}}" alt="Secondary Image">
                                    </a>
                                </div>
                                <div class="grid__wraper__icon">                                
                                    <ul>
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-4 col-sm-6 col-6">
                        <div class="grid__wraper">
                            <div class="grid__wraper__img">
                                <div class="grid__wraper__img__inner">
                                    <a href="single-product.html">
                                        <img class="primary__image" src="{{asset('img/grid/grid__23.png')}}" alt="Primary Image">
                                        <img class="secondary__image" src="{{asset('img/grid/grid__24.png')}}" alt="Secondary Image">
                                    </a>
                                </div>
                                <div class="grid__wraper__icon">                                
                                    <ul>
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-4 col-sm-6 col-6">
                        <div class="grid__wraper">
                            <div class="grid__wraper__img">
                                <div class="grid__wraper__img__inner">
                                    <a href="single-product.html">
                                        <img class="primary__image" src="{{asset('img/grid/grid__25.png')}}" alt="Primary Image">
                                        <img class="secondary__image" src="{{asset('img/grid/grid__26.png')}}" alt="Secondary Image">
                                    </a>
                                </div>
                                <div class="grid__wraper__icon">                                
                                    <ul>
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-4 col-sm-6 col-6">
                        <div class="grid__wraper">
                            <div class="grid__wraper__img">
                                <div class="grid__wraper__img__inner">
                                    <a href="single-product.html">
                                        <img class="primary__image" src="{{asset('img/grid/grid__27.png')}}" alt="Primary Image">
                                        <img class="secondary__image" src="{{asset('img/grid/grid__29.png')}}" alt="Secondary Image">
                                    </a>
                                </div>
                                <div class="grid__wraper__icon">                                
                                    <ul>
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-4 col-sm-6 col-6">
                        <div class="grid__wraper">
                            <div class="grid__wraper__img">
                                <div class="grid__wraper__img__inner">
                                    <a href="single-product.html">
                                        <img class="primary__image" src="{{asset('img/grid/grid__29.png')}}" alt="Primary Image">
                                        <img class="secondary__image" src="{{asset('img/grid/grid__30.png')}}" alt="Secondary Image">
                                    </a>
                                </div>
                                <div class="grid__wraper__icon">                                
                                    <ul>
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-4 col-sm-6 col-6">
                        <div class="grid__wraper">
                            <div class="grid__wraper__img">
                                <div class="grid__wraper__img__inner">
                                    <a href="single-product.html">
                                        <img class="primary__image" src="{{asset('img/grid/grid__31.png')}}" alt="Primary Image">
                                        <img class="secondary__image" src="{{asset('img/grid/grid__32.png')}}" alt="Secondary Image">
                                    </a>
                                </div>
                                <div class="grid__wraper__icon">                                
                                    <ul>
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-4 col-sm-6 col-6">
                        <div class="grid__wraper">
                            <div class="grid__wraper__img">
                                <div class="grid__wraper__img__inner">
                                    <a href="single-product.html">
                                        <img class="primary__image" src="{{asset('img/grid/grid__33.png')}}" alt="Primary Image">
                                        <img class="secondary__image" src="{{asset('img/grid/grid__34.png')}}" alt="Secondary Image">
                                    </a>
                                </div>
                                <div class="grid__wraper__icon">                                
                                    <ul>
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-4 col-sm-6 col-6">
                        <div class="grid__wraper">
                            <div class="grid__wraper__img">
                                <div class="grid__wraper__img__inner">
                                    <a href="single-product.html">
                                        <img class="primary__image" src="{{asset('img/grid/grid__35.png')}}" alt="Primary Image">
                                        <img class="secondary__image" src="{{asset('img/grid/grid__36.png')}}" alt="Secondary Image">
                                    </a>
                                </div>
                                <div class="grid__wraper__icon">                                
                                    <ul>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-xl-6 col-lg-6 col-md-12 col-12">
                    <div class="cowndown__banner__img">
                        <img src="{{asset('img/banner/banner__3.png')}}" alt="">
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="col-xl-3 column__custom__class">
                            <div class="grid__wraper">
                                <div class="grid__wraper__img">
                                    <div class="grid__wraper__img__inner">
                                        <a href="single-product.html">
                                            <img class="primary__image" src="{{asset('img/grid/grid__19.png')}}" alt="Primary Image">
                                            <img class="secondary__image" src="{{asset('img/grid/grid__20.png')}}" alt="Secondary Image">
                                        </a>
                                    </div>
                                    <div class="grid__wraper__icon">                                
                                        <ul>
                        ...
                        <div class="col-xl-3 column__custom__class">
                            <div class="grid__wraper">
                                <div class="grid__wraper__img">
                                    <div class="grid__wraper__img__inner">
                                        <a href="single-product.html">
                                            <img class="primary__image" src="{{asset('img/grid/grid__13.png')}}" alt="Primary Image">
                                            <img class="secondary__image" src="{{asset('img/grid/grid__14.png')}}" alt="Secondary Image">
                                        </a>
                                    </div>
                                    <div class="grid__wraper__icon">                                
                                        <ul>
                        ...
                        <div class="col-xl-3 column__custom__class">
                            <div class="grid__wraper">
                                <div class="grid__wraper__img">
                                    <div class="grid__wraper__img__inner">
                                        <a href="single-product.html">
                                            <img class="primary__image" src="{{asset('img/grid/grid__11.png')}}" alt="Primary Image">
                                            <img class="secondary__image" src="{{asset('img/grid/grid__12.png')}}" alt="Secondary Image">
                                        </a>
                                    </div>
                                    <div class="grid__wraper__icon">                                
                                        <ul>
                        ...
                        <div class="col-xl-3 column__custom__class">
                            <div class="grid__wraper">
                                <div class="grid__wraper__img">
                                    <div class="grid__wraper__img__inner">
                                        <a href="single-product.html">
                                            <img class="primary__image" src="{{asset('img/grid/grid__9.png')}}" alt="Primary Image">
                                            <img class="secondary__image" src="{{asset('img/grid/grid__10.png')}}" alt="Secondary Image">
                                        </a>
                                    </div>
                                    <div class="grid__wraper__icon">                                
                                        <ul>
...
<div class="col-xl-4 column__custom__class">
    <div class="blog__single__wrap">
        <div class="blog__img">
           <a href="blog-details.html"> <img src="{{asset('img/blog/blog-1.jpg')}}" alt=""></a>
        </div>
...
<div class="col-xl-4 column__custom__class">
    <div class="blog__single__wrap">
        <div class="blog__img">
            <a href="blog-details.html"> <img src="{{asset('img/blog/blog-2.jpg')}}" alt=""></a>
        </div>
...
<div class="col-xl-4 column__custom__class">
    <div class="blog__single__wrap">
        <div class="blog__img">
            <a href="blog-details.html"> <img src="{{asset('img/blog/blog-3.jpg')}}" alt=""></a>
        </div>
...
<div class="col-xl-4 column__custom__class">
    <div class="blog__single__wrap">
        <div class="blog__img">
            <a href="blog-details.html"> <img src="{{asset('img/blog/blog-4.jpg')}}" alt=""></a>
        </div>
...
<div class="col-xl-4 column__custom__class">
    <div class="blog__single__wrap">
        <div class="blog__img">
            <a href="blog-details.html"> <img src="{{asset('img/blog/blog-5.jpg')}}" alt=""></a>
        </div>
...
<div class="col-xl-4 column__custom__class">
    <div class="blog__single__wrap">
        <div class="blog__img">
            <a href="blog-details.html"> <img src="{{asset('img/blog/blog-6.jpg')}}" alt=""></a>
        </div>
...
<div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12">
    <div class="feature__2__single">
        <div class="feature__2__icon">
            <img src="{{asset('img/feature/feature__1.svg')}}" alt="">
        </div>
...
<div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12">
    <div class="feature__2__single">
        <div class="feature__2__icon">
            <img src="{{asset('img/feature/feature__2.svg')}}" alt="">
        </div>
        <div class="feature__2__text">
            <h4>Money Back</h4>
...
<div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12">
    <div class="feature__2__single">
        <div class="feature__2__icon">
            <img src="{{asset('img/feature/feature__3.svg')}}" alt="">
        </div>
        <div class="feature__2__text">
...
<div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12">
    <div class="feature__2__single">
        <div class="feature__2__icon">
            <img src="{{asset('img/feature/feature__4.svg')}}" alt="">
        </div>
        <div class="feature__2__text">
...
<div class="col-sm-12 column__custom__class">
    <div class="instagram__img">
        <a class="popup__img" href="{{asset('img/instagram/gallery-1.jpg')}}"> <img src="{{asset('img/instagram/gallery-1.jpg')}}" alt="Instagram Gallery Image"></a>
     </div>
</div>

<div class="col-sm-12 column__custom__class">
    <div class="instagram__img">
        <a class="popup__img" href="{{asset('img/instagram/gallery-2.jpg')}}"> <img src="{{asset('img/instagram/gallery-2.jpg')}}" alt="Instagram Gallery Image"></a>
     </div>
</div>

<div class="col-sm-12 column__custom__class">
    <div class="instagram__img">
        <a class="popup__img" href="{{asset('img/instagram/gallery-3.jpg')}}"> <img src="{{asset('img/instagram/gallery-3.jpg')}}" alt="Instagram Gallery Image"></a>
     </div>
</div>

<div class="col-sm-12 column__custom__class">
    <div class="instagram__img">
        <a class="popup__img" href="{{asset('img/instagram/gallery-4.jpg')}}"> <img src="{{asset('img/instagram/gallery-4.jpg')}}" alt="Instagram Gallery Image"></a>
     </div>
</div>

<div class="col-sm-12 column__custom__class">
    <div class="instagram__img">
        <a class="popup__img" href="{{asset('img/instagram/gallery-6.jpg')}}"> <img src="{{asset('img/instagram/gallery-6.jpg')}}" alt="Instagram Gallery Image"></a>
     </div>
</div>

<div class="col-sm-12 column__custom__class">
    <div class="instagram__img">
        <a class="popup__img" href="{{asset('img/instagram/gallery-7.jpg')}}"> <img src="{{asset('img/instagram/gallery-7.jpg')}}" alt="Instagram Gallery Image"></a>
     </div>
</div>
